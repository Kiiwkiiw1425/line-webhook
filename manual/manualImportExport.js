...
const importExportManual = createSubmenu('📥 นำเข้า/ส่งออกข้อมูล', [
  ...
  {label: '📤 ส่งออกข้อมูลข ขรก.(GMIS)', uri: 'https://ocscthailand.sharepoint.com/:b:/s/ictUnit-DPIS/EYKpH5HtrRdBoTWSaWekZ78BdwxbQz-XKBSEOvBfzZ_4AA?e=WdWAdu'},
  {label: '📤 ส่งออกข้อมูล พรก.(GEIS)', uri: 'https://ocscthailand.sharepoint.com/:b:/s/ictUnit-DPIS/ERhqIRc1GI9Jscu6WfqMl68BmeKhkRBgnhUc4oq8QGjCWA?e=9Yt20w'}
]);
