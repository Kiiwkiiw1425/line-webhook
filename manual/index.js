...
// *** สำคัญ: ชื่อภาษาไทยตรงนี้ ต้องตรงกับคีย์ใน 'matchCategory.js' ***
...
        }
    } catch (e) {
        // ดักจับ error หากไฟล์ย่อยมีปัญหาด้าน Syntax
        console.error(`🚨 Error loading manual file ${file}: ${e.message}`);
    }
  }
});
