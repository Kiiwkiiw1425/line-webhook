...
const keywordMap = {
  ...
  'สิทธิการใช้งาน': ['สิทธิ์', 'สิทธิการใช้งาน', 'ผู้ใช้', 'การเข้าถึง', 'จัดการสิทธิ์', 'ตั้งค่าผู้ลงนาม', 'ตั้งค่าลงนาม', 'user access', 'ลงนาม', 'ตั้งค่าผู้มีอำนาจลงนาม', 'ผู้มีอำนาจลงนาม', 'สิทธืการมองเห็น', 'เพิ่มกลุ่มผู้ใช้งาน', 'เพิ่มกลุ่ม', 'จัดการข้อมูลลงทะเบียน', 'จัดการข้อมูล', 'ข้อมูลลงทะเบียน', 'จัดการสิทธิ์ผู้ใช้งาน', 'สิทธิ์ผู้ใช้งาน', 'สิทธิผู้ใช้งาน'],
  'การลา': ['ลา', 'ลางาน', 'ตั้งค่าการลา', 'ตั้งค่าปฏิทินวันหยุด', 'ปฏิทินวันหยุด', 'กําหนดผู้มีสิทธิอนุญาตลา', 'ผู้มีสิทธิอนุญาตลา', 'อนุญาตลา', 'ยกเลิกคำขอลา', 'อนุมัติคำร้อง', 'อนุมัติการลา', 'ยื่นลา', 'คำขอลา', 'วันลา', 'ลาออนไลน์', 'ลาแอพ', 'ใบลา', 'สิทธิลา', 'ขอลงเวลา', 'แก้ไขคำขอลา'],
...
for (const [category, keywords] of Object.entries(keywordMap)) {
  for (const keyword of keywords) {
    fuseData.push({ category, keyword: normalize(keyword) });
  }
}
